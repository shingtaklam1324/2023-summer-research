...
\section{Manifold structure of \(M(\rho)\)}

In this section, we will compute the manifold structure of \(M(\rho)\), following \cite{kronheimer_hyper-kahlerian_1990}. Note that \cite{kronheimer_hyper-kahlerian_1990} is for \emph{regular semisimple} orbits, therefore there are a few modifications which are required.
